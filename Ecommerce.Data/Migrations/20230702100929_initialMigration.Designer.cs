...
namespace Ecommerce.Data.Migrations
{
    ...
    [Migration("20230702100929_initialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d350856b-93ed-42db-b6c2-26eba129022e",
                            ConcurrencyStamp = "1",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = "2d190956-d41b-4c8a-9e65-ae212f85dd1f",
                            ConcurrencyStamp = "2",
                            Name = "User",
                            NormalizedName = "USER"
                        });
            ...
            modelBuilder.Entity("Ecommerce.Model.Entities.ApplicationUser", b =>
                {
                    b.HasOne("Ecommerce.Model.Entities.Cart", "Cart")
                        .WithOne("User")
                        .HasForeignKey("Ecommerce.Model.Entities.ApplicationUser", "CartId");
            ...
            modelBuilder.Entity("Ecommerce.Model.Entities.Wishlist", b =>
                {
                    b.HasOne("Ecommerce.Model.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne("Wishlist")
                        .HasForeignKey("Ecommerce.Model.Entities.Wishlist", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
